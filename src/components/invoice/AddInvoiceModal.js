...
const AddItemModal = () => {
  ...
  return (
      <div>
        <button onClick={() => setShowModal(true)} className="flex items-center bg-pink-500 active:bg-pink-600 hover:shadow-lg outline-none focus:outline-none text-white font-bold py-2 px-4 rounded fixed top-0 right-0"><FaPlusSquare/>new Invoice</button>
        ...
        <>
          ...
          >
            <div className="relative w-full my-3 mx-auto max-w-3xl">
              {/*content*/}
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                    ...
                    <form className="bg-white rounded px-8 pt-6 pb-2 mb-4" onSubmit={formik.handleSubmit}>
                        <h2 className="text-center font-bold mb-4">Add new Invoice</h2>
